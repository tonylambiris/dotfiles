...
if zplug check "bhilburn/powerlevel9k"; then
	...
	P9K_LEFT_SUBSEGMENT_SEPARATOR="%F{232}\uE0BD%f"
	P9K_RIGHT_SUBSEGMENT_SEPARATOR="%F{232}\uE0BD%f"
	...
	P9K_MULTILINE_FIRST_PROMPT_PREFIX="%F{$PROMPT_COLOR}%f"
	P9K_MULTILINE_LAST_PROMPT_PREFIX="%F{$PROMPT_COLOR}➜  %f"
